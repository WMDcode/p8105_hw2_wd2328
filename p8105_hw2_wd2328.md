...
```
    ...
    ## # A tibble: 5 × 8
    ##   region_id size_rank zip_code state city     county date       rental_price
    ##       <dbl>     <dbl>    <dbl> <chr> <chr>    <chr>  <date>            <dbl>
    ## 1     62080         4    11368 NY    New York Queens 2015-01-31           NA
    ## 2     62080         4    11368 NY    New York Queens 2015-02-28           NA
    ## 3     62080         4    11368 NY    New York Queens 2015-03-31           NA
    ## 4     62080         4    11368 NY    New York Queens 2015-04-30           NA
    ## 5     62080         4    11368 NY    New York Queens 2015-05-31           NA
...
```
    ...
    ## # ℹ 2 more variables: size_rank <dbl>, rental_price <dbl>

The resulting data-set `problem3_df` is…
