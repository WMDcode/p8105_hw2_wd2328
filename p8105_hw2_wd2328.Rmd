...
There are `r length(pull(filter(problem3_df, is.na(date), zip_code != "11693"), zip_code))` Zip Codes included in Zip Code data but not the Zillow data. These include: 
```{r}
problem3_df |>
  filter(is.na(date),
         zip_code != "11693") |>
